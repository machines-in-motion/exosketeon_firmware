...
int latest_command_timestamp = 0;
...
void can_events()
{
	...
	{
		response_flag = false;
		sendFDCANRespond(rxHeader.Identifier, state_packet.buffer, sizeof(state_packet.buffer));
	}
}
